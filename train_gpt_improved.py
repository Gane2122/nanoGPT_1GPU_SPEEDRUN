...
- Higher learning rates (embeddings at 0.6)
- tanh logit scaling
- Separate optimizers per component type
- Keeps smear_gate, backout_lambda, and other custom architecture
"""
import os
import sys
...
class Hyperparameters:
    ...
    batch_size: int = 16  # Accumulation steps
    sequence_length: int = 32 * 1024  # 32K context
    num_iterations: int = 1750
    warmup_iters: int = 0  # No warmup
    cooldown_iters: int = 640  # Linear cooldown
